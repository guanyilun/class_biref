...
struct transfer {
  ...
  /** @name - YG: birefringence parameters */

  //@{

  short biref_has_file;       /**< flag stating whether we need to read the beta values from a file */
  FileName biref_beta_file;   /**< file name for the beta values */ 
  int biref_beta_size;        /**< number of beta values */
  double * biref_tau_table;   /**< list of tau values, biref_tau[index_tau] */
  double * biref_beta_table;  /**< list of beta values, biref_beta[index_tau] */
  double * biref_beta_table_spline; /**< for spline interpolation of beta, store ddbeta */
  double * biref_beta;        /**<  store the beta value for each given tau sampling, biref_beta[index_tau] */
...
typedef enum {SCALAR_TEMPERATURE_0,
              ...
              SCALAR_POLARISATION_B,  // YG: add B-mode in scalar due to biref
